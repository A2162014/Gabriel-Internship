...
from helpers.maps import connect_to_database, fetch_area_line_data_tab2, create_full_map, extract_full_mappings
...
def update_tree_widget(tree_widget, area_value_line_edit_short, area_value_line_edit_full, line_value_line_edit_short,
    ...
    with connect_to_database() as conn:
        tree_widget.clear()
        single_map = create_full_map(conn)
        area_line_map, line_machine_map, machine_problem_map, problem_caction_map = extract_full_mappings(single_map)
                    ...
                    if not line_row:
                        ...
                        if machine_count > 0:
                            QMessageBox.information(None, "Warning",
                                                    "There are machines associated with this line. Please delete the machines first.")
                            return
                        else:
